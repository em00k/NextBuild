...
LoadSD("music.pt3",51310,8000,0)
#include "IM2player.bas"

NextReg($43,$1)						' ULANext control reg
NextReg($42,63)						' ULANext number of inks : 255 127 63 31 15 7 
...
PalUpload(@Palette,255,0) ' load entire 512 bytes for 9bit 256x2 colours entries
